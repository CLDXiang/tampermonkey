...
// @version 1.0
// @description 在不支持苹方的情况下采用和 Bilibili 一样的 HarmonyOS 字体，提升阅读体验。仅对常见根节点进行检查，不支持部分字体未声明在根节点的页面，不支持声明了 CSP 限制的页面（如 GitHub）
// @author CLDXiang
...
(() => {
  ...
  @font-face {
    ...
    if (currentFontFamily.includes("PingFang SC"))
      appElement.style.fontFamily = currentFontFamily.replace("PingFang SC", "PingFang SC, HarmonyOS_Regular");
    else
